...
?>
    ...
    <div class="Checkout_section mt-60">
        <div class="container">
            ...
            <form method="post" action="index.php?page=save_data">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-20">
                                    ...
                                    <input placeholder="House number and street name" type="text"name="street_name1">     
                                </div>
                                <div class="col-12 mb-20">
                                    <input placeholder="Apartment, suite, unit etc. (optional)" type="text"name="street_name2">     
                                </div>
                                <div class="col-12 mb-20">
                                ...
                                <div class="col-12 mb-20 accordion" id="accordionExample">
                                    <input id="address" type="checkbox" data-target="createp_account" name="different" />
                                    ...
                                    <div id="collapseTwo" class="collapse" data-parent="#accordionExample">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-20">
                                                <label>Company Name</label>
                                                <input type="text" name="company_name2">     
                                            </div>
                                            <div class="col-12 mb-20">
                                                <div class="select_form_select">
                                                    <label for="countru_name">country <span>*</span></label>
                                                    <select class="niceselect_option" name="country2" id="countru_name"> 
                                                        ...
                                                        <option value="Bahrain">Colombia</option>    
                                            ...
                                            <div class="col-12 mb-20">
                                                <label>Street address  <span>*</span></label>
                                                <input placeholder="House number and street name" type="text" name="street_name1_2">     
                                            </div>
                                            <div class="col-12 mb-20">
                                                <input placeholder="Apartment, suite, unit etc. (optional)" type="text" name="street_name2_2">     
                                            </div>
                                            <div class="col-12 mb-20">
                                                <label>Town / City <span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="order-notes">
                                        ...
                                        <textarea name="order_notes" id="order_note" rows="2" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                    </div>    
                                </div>     	    	    	    	    	    	    
                            </div>
                    </div>
                    <div class="col-lg-6 col-md-6"> 
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php foreach($items as $item):?>
                                            ...
                                            <input type="hidden" name="product_name[]" value="<?=$item->getProduct()->getName()?>">
                                            <input type="hidden" name="product_qty[]" value="<?=$item->getQty()?>">
                                            <td><?=$item->getProduct()->getName()?> <strong> × <?=$item->getQty()?></strong></td>
                                            <input type="hidden" name="item_price[]" value="<?=$item->getItemPrice()?>">
                                            <input type="hidden" name="product_price[]" value="<?=$item->getProduct()->getPrice()?>">
                                            <td> $<?=$item->getItemPrice()?></td>
                                        </tr>
                                        <?php endforeach;?>
                                    </tbody>
                                    <tfoot>
                                        <tr> <tr><?php if(!empty($cart->getTotalPrice())) :?>
                                            <th>Cart Subtotal</th>
                                            <input type="hidden" name="cart_subtotal" value="<?=$cart->getTotalPrice()?>">
                                        ...
                                        <tr class="order_total">
                                            <th>Order Total</th>
                                            <input type="hidden" name="order_total"value="<?=$cart->getTotalPrice()+50?>">
                                            <td><strong>$<?=$cart->getTotalPrice()+50?></strong></td> <?php endif;?>
                                        </tr>
                                    </tfoot>
                                </table>     
                            </div>
                            <div class="payment_method">
                                <div class="panel-default">
                                    <input value="Bank" id="payment" name="check_method" type="radio" data-target="createp_account" />
                                ...
                                <div class="panel-default">
                                    <input value="Paypal" id="payment_defult" name="check_method" type="radio" data-target="createp_account" />
                                ...
                                <div class="order_button">
                                    <button  type="submit" name="send_data">Proceed to buy</button> 
                                </div>   
                            </div>       
                    </div>  
                </div>
