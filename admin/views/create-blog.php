...
?>
			...
			<div class="content-wrapper">
				...
				<form  action="index.php?page=create_blog_controller" method="post"enctype="multipart/form-data">
					<!-- Default box -->
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="long_description" id="long_description" class="form-control" placeholder="Long_Description">	
										</div>
									</div>
									<div class="col-md-6">
										<div class="mb-3">
